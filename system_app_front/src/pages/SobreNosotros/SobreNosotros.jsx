  ...
  render() {
    return (
      <div className="bodySN">
        ...
        <div className="let">
          <p>
            Este sistema administrativo tiene como objetivo principal servir de
            guía en el proceso de cotización y compras de un determinado
            proyecto en construcción, favoreciendo el cumplimiento de los
          ...
          {"  "}
          <p>
            En este proyecto se realizará el desarrollo y documentación de
            Sistema administrativo para la compañía de servicios Méndez,
            llamados MS Méndez Services y que se realizará bajo las
            especificaciones y estandarización de las normas de tecnologías de
            la información y comunicación (NORTIC).
          </p>
          {"  "}
          <p>
          ...
          <p>
            ...
            <ul>
              <li>
                <b>Cotizaciones:</b> crear documentos que el departamento de
                compras usa en una negociación.
              </li>
              <li>
                <b>Compras:</b> hacer uso de las cotizaciones previas ya
                creadas, entregadas y analizadas.
              </li>
            </ul>
          </p>
        </div>
